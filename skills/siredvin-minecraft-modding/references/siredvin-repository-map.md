...
| GTCEu addon repository | local build-environment migration branch | MC 1.20.1, Forge 47.4.10, GTCEu | single `src/main` Forge project | AGENTS.md says Java 17, mod id `gttruesteam`, package `site.siredvin.gttruesteam`; custom build conventions 0.9.0; uses GTCEu/KubeJS/Rhino/Architectury/JEI/EMI/LDLib/Registrate. |
